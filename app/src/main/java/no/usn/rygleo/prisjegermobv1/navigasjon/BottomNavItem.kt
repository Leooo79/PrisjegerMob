...
sealed class BottomNavItem(var title: Int, var icon:Int, var screen_route:String){
    ...
    object Prissammenligning: BottomNavItem(R.string.priceComparison,R.drawable.ic_post,"add_post")
    ...
    object Kart: BottomNavItem(R.string.map, R.drawable.ic_my_network, "kart")
